  ...
  return (
    ...
    <Box
      ...
      sx={{
        ...
        alignItems: "center",
        padding: 4,
        background: "linear-gradient(135deg, #c0c0c0, #000)",// Updated gradient to silver and black
        borderRadius: 3,
    ...
    >
      ...
      <Button
        ...
        sx={{
          padding: "12px",
          fontSize: "16px",
          backgroundColor: "#555", // dark gray for button background
          color: "#fff",
          "&:hover": {
            backgroundColor: "#444", // darker hover effect
          },
          "&:disabled": {
            backgroundColor: "#777", // disabled state styling
          },
        }}
